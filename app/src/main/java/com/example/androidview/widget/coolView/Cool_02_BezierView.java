...
//贝塞尔曲线
public class Cool_02_BezierView extends View {
    private Paint mPaint;
    private Paint mLinePointPaint;
    private Path mPath;
    private List<PointF> mControlPoints;//控制点集合（包含数据点）

    public Cool_02_BezierView(Context context) {
        super(context);
        initPaint();
        init();
    }

    public Cool_02_BezierView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initPaint();
        init();
    }

    public Cool_02_BezierView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
