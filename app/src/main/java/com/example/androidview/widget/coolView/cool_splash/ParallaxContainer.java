...
import com.example.androidview.ui.activity.MainActivity;
...
//                    ViewHelper.setTranslationY(view, (containerWidth - positionOffsetPixels) * tag.yIn);
                    view.setTranslationY((containerWidth - positionOffsetPixels) * tag.xIn);
                    view.setTranslationX((containerWidth - positionOffsetPixels) * tag.yIn);
                }
